...
Random Forest is an ensemble learning method that builds multiple decision trees and combines their outputs to improve predictive accuracy and reduce overfitting. Each tree is trained on a random subset of the data and features, which increases model robustness and generalization. In this project, Random Forest was used to predict monthly rental prices by leveraging property features. It is well-suited for handling complex, non-linear relationships and provides good performance even with noisy or unbalanced data. Additionally, it offers feature importance insights, which help in understanding the influence of different variables on rental pricing.
...
CatBoost is a high-performance gradient boosting algorithm developed by Yandex, designed to handle categorical features effectively without the need for extensive preprocessing. In this project, CatBoost was used to predict monthly rental prices based on property features. It automatically manages categorical variables, reduces overfitting, and performs well even with relatively small datasets. CatBoost is particularly useful when dealing with mixed data types and delivers strong predictive accuracy while maintaining stability and ease of use.
...
In this classification task, CatBoost was used to predict the furnishing status of rental properties using features such as rental price, property size, property type, property age, proximity to public transport, and available facilities. Its ability to automatically process categorical variables and prevent overfitting makes it highly suitable for multi-class classification problems, offering both strong predictive performance and ease of implementation.
...
The Random Forest Classifier is an ensemble learning method that builds multiple decision trees and combines their outputs to improve prediction accuracy and generalization. In this project, it was used to predict the furnishing status of rental properties based on key features such as rental price, property size, property type, property age, proximity to public transport, and available facilities. By averaging the results of many diverse trees, the model reduces overfitting and handles both linear and non-linear relationships effectively. It also provides insights into feature importance, helping to understand which variables most influence the furnishing status.
...
Support Vector Machines (SVM) is a powerful classification algorithm that works by finding the optimal hyperplane that best separates classes in the feature space. In this project, SVM was used to classify the furnishing status of rental properties based on features such as rental price, property size, property type, property age, proximity to public transport, and available facilities. SVM is particularly effective in handling high-dimensional data and can model non-linear decision boundaries using kernel functions. Although it may require careful tuning and is less interpretable than tree-based models, SVM often delivers strong performance in structured classification tasks.
